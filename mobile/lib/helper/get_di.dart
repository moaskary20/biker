...
import 'package:sixam_mart/features/blog/domain/repositories/blog_repository.dart';
import 'package:sixam_mart/features/blog/domain/services/blog_service.dart';
...
Future<Map<String, Map<String, String>>> init() async {
  ...
  // Blog - will be registered in the main section
  ...
  Get.lazyPut(() => TaxiFavouriteController(taxiFavouriteServiceInterface: Get.find()));
    ...
    // Blog
    Get.lazyPut<BlogServiceInterface>(() => BlogService(apiClient: Get.find()));
    Get.lazyPut<BlogRepositoryInterface>(() => BlogRepository(blogServiceInterface: Get.find()));
    Get.lazyPut(() => BlogController(blogRepositoryInterface: Get.find()));
