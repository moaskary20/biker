...
import 'package:sixam_mart/features/blog/screens/blog_detail_screen.dart';
...
class RouteHelper {
  ...
  static String getBlogListRoute() => blogList;
  static String getBlogDetailRoute() => blogDetail;
  ...
  static List<GetPage> routes = [
    ...
    // Blog Routes
    GetPage(name: blogList, page: () => getRoute(const BlogListScreen())),
    GetPage(name: blogDetail, page: () => getRoute(BlogDetailScreen(post: Get.arguments))),
  ];
