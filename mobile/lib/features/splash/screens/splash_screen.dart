...
class SplashScreenState extends State<SplashScreen> {
  ...
  void initState() {
    ...
    // _route();
    Get.find<SplashController>().getConfigData(notificationBody: widget.body);
    print('Called getConfigData from SplashScreen');
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<SplashController>(builder: (splashController) {
        print('SplashController.hasConnection: [32m' + splashController.hasConnection.toString() + '\u001b[0m');
        print('SplashController.configModel: ' + (splashController.configModel == null ? 'null' : 'loaded'));
        ...
        if (splashController.configModel == null) {
          // عرض مؤشر تحميل أو رسالة بدل الشاشة السوداء
